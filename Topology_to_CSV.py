...
def match(R,G,B , topologyData):
    deviation = 0
    threshhold = 10 #allowable amount of deviation from exact RGB pixel value
    for i in range (13):
...
topologyData = [[209, 250, 254, -2.5], #format [R,G,B, pgh]
                [194, 241, 195, 0], [176, 230, 119, 2.5],
                [145, 204, 110, 5.0],[112, 180, 103, 7.5],
                [79, 158, 95, 10.0], [55, 139, 89, 12.5],
                [49, 121, 73, 15.0], [64, 107, 53, 17.5],
                [77, 95, 37, 20.0], [90, 96, 36, 22.5],
                [103, 98, 42, 25.0], [115, 99, 47, 27.5],
                [137, 101, 57, 30.0]] 
